...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-s1r9n80.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-s1r9n80.containers.anotherwebservice.com/
...
```
git clone git@github.com:Leave-MeAlone/container-s1r9n80.git
cd container-s1r9n80
```
...
```
docker attach container-s1r9n80
```
